...
class Country extends Model
{
    ...
    protected $rows = [
        ...
        ["code" => "TF", "code3" => "ATF", "name" => "French Southern and Antarctic Lands", "number" => "260"],
        ...
        ["code" => "BQ", "code3" => "BES", "name" => "Caribbean Netherlands", "number" => "535"],
        ...
        ["code" => "CI", "code3" => "CIV", "name" => "Ivory Coast", "number" => "384"],
        ["code" => "CM", "code3" => "CMR", "name" => "Cameroon", "number" => "120"],
        ["code" => "CD", "code3" => "COD", "name" => "DR Congo", "number" => "180"],
        ["code" => "CG", "code3" => "COG", "name" => "Republic of the Congo", "number" => "178"],
        ["code" => "CK", "code3" => "COK", "name" => "Cook Islands", "number" => "184"],
        ["code" => "CO", "code3" => "COL", "name" => "Colombia", "number" => "170"],
        ["code" => "KM", "code3" => "COM", "name" => "Comoros", "number" => "174"],
        ["code" => "CV", "code3" => "CPV", "name" => "Cape Verde", "number" => "132"],
        ...
        ["code" => "XK", "code3" => "UNK", "name" => "Kosovo", "number" => ""],
        ...
        ["code" => "MO", "code3" => "MAC", "name" => "Macau", "number" => "446"],
        ...
        ["code" => "PN", "code3" => "PCN", "name" => "Pitcairn Islands", "number" => "612"],
        ...
        ["code" => "GS", "code3" => "SGS", "name" => "South Georgia", "number" => "239"],
        ...
        ["code" => "ST", "code3" => "STP", "name" => "S\u00e3o Tom\u00e9 and Pr\u00edncipe", "number" => "678"],
